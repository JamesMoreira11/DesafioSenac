<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DateBox.ascx.cs" Inherits="Controles_DateBox" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Panel ID="pnlEdicao" runat="server" Style="display: inline;">
    ...
    <b>
        <asp:Label ID="lblDoisPontos" runat="server" Text=":"></asp:Label></b>
...
<font face="Verdana" size="1" color="#336699"><b><asp:Label ID="lblData" runat="server" Text="" Visible=false></asp:Label></b></font>
